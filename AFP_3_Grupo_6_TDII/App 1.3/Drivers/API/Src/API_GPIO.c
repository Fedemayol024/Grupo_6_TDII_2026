...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, led_verde_Pin|led_rojo_Pin|led_azul_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : led_verde_Pin led_rojo_Pin led_azul_Pin */
  GPIO_InitStruct.Pin = led_verde_Pin|led_rojo_Pin|led_azul_Pin;
...
buttonStatus_t ReadButton_GPIO(void) {
	return HAL_GPIO_ReadPin(GPIOC, Pulsador_Pin);
}
