 ...
 * @brief Aplicación de secuencia de LEDs bidireccional mediante MEF y pulsador.
 * @details Módulo de Capa 3 que gestiona la alternancia de encendido/apagado de LEDs
 *          y la inversión dinámica de giro mediante la detección de flancos del USER_Btn,
 *          utilizando drivers genéricos (LED, Botón, nb_delay) sobre STM32F439ZI Nucleo-144.
 * @version 1.0
 * @date 2026
 *
 * @attention
...
int main(void)
{
	...
	while (1)
	{
		...
		/*
		 * 2. MEF de secuencia gobernada por el evento de expiración de nb_delay
		 */
		if (nb_delay_read(&delay_mef))
		{
			...
			case Estado_Encendido:
				/* Enciende el LED correspondiente al índice activo */
			...
			case Estado_Apagado:
				...
				/* Cálculo del nuevo índice según el sentido */
				indice_led += sentido;
